...
use ESMF             , only : ESMF_GridComp, ESMF_SUCCESS, ESMF_Grid, ESMF_DistGrid, ESMF_DistGridConnection
use ESMF             , only : ESMF_State, ESMF_Field, ESMF_Grid, ESMF_Array, ESMF_Mesh, ESMF_Clock, ESMF_TimeInterval
...
use ESMF             , only : ESMF_MAXSTR, ESMF_FieldWriteVTK
...
type(ESMF_GridComp)                 :: dgcomp, verticalDim
integer, INTENT(OUT)                :: rc
type(ESMF_State)                    :: importState, exportState
type(ESMF_Field)                    :: field
type(ESMF_Grid)                     :: grid
